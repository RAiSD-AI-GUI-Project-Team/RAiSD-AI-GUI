...
class RunPage(Page):
    """
    The page of the RAiSD-AI GUI application to show
    all steps of running RAiSD-AI.
    """
    ...
    def _setup_stacked_step_widget(self, layout: QStackedLayout):
        ...
        self.operation_selection_widget = OperationSelectionWidget(run_record=self.run_record)
        ...
        self.parameter_input_widget = ParameterInputWidget(run_record=self.run_record)
        ...
        self.parameter_confirmation_widget = ParameterConfirmationWidget(run_record=self.run_record)
        ...
        # Run view widget
        self.run_view_widget = RunViewWidget(run_record=self.run_record, command_executor=self.command_executor)
        ...
        # Results widget
        self.run_results_widget = RunResultsWidget(run_record=self.run_record)
    ...
    def _handle_run_end(self, run_successful: bool) -> None:
        if run_successful:
            history_record = self.run_record.to_history_record() 
